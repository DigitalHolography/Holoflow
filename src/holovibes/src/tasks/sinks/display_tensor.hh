...
struct DisplayTensorSettings {
  ...
  bool operator==(const DisplayTensorSettings &) const = default;
};

void to_json(nlohmann::json &j, const DisplayTensorSettings &settings);
void from_json(const nlohmann::json &j, DisplayTensorSettings &settings);

// -------------------------------------------------------------------------------------------------
// DisplayTensorFactory
// -------------------------------------------------------------------------------------------------
