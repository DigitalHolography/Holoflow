...
DEFINE_SOURCE_SYNC_NODE(short_time_fresnel_phase_ramps,         "short_time_fresnel_phase_ramps",       "ShortTimeFresnelPhaseRamps",       holotask::syncs::ShortTimeFresnelPhaseSettings)
