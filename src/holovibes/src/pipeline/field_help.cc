...
const FieldHelp kFieldHelp[] = {
    ...
    {SettingsField::RecordingMotionCompensation, "Motion Compensation",
     "Aligns captured image frames before producing the average export.",
     kRecordingMotionCompensationConstraints},
