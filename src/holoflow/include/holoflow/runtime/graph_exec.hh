...
public:
  ...
  /// Returns the node currently executing on the calling scheduler thread.
  /// The view remains valid while the compiled graph is alive.
  [[nodiscard]] std::string_view current_node_name() const noexcept;
