...
struct DualReaderBatchQueueSettings {
  size_t target_capacity;
  size_t window_size;

  bool operator==(const DualReaderBatchQueueSettings &) const = default;
};
...
class DualReaderBatchQueueFactory : public holoflow::core::IAsyncTaskFactory {
public:
