...
std::int64_t product(const std::vector<size_t>& shape) {
  ...
  for (const auto dim : shape) {
    if (dim == 0 || result > std::numeric_limits<std::int64_t>::max() /
...
std::vector<std::int64_t> compact_strides(const std::vector<size_t>& shape) {
...
ReductionPlan make_plan(const holoflow::core::TDesc& desc, const ReductionSettings& settings) {
  ...
  if (desc.strides.empty()) {
    plan.input_strides = compact_strides(desc.shape);
  } else {
  ...
  plan.output_strides = compact_strides(plan.output_shape);
  plan.reduction_strides = compact_strides(reduction_shape);
  return plan;
}
...
public:
  ...
  holoflow::core::OpResult execute(holoflow::core::SyncCtx& context) override {
    ...
    const int grid_size =
        static_cast<int>((plan_.output_elements + block_size - 1) / block_size);
...
holoflow::core::InferResult reduction_infer(std::span<const holoflow::core::TDesc> inputs,
  ...
  if (plan.output_shape.empty())
    throw std::invalid_argument("scalar reduction outputs are not supported");
  return {{inputs[0]},
          {{plan.output_shape, output_dtype, holoflow::core::MemLoc::Device}},
          {},
          {false},
          {false},
...
template <class SettingsType>
std::unique_ptr<holoflow::core::ISyncTask> reduction_create(
    std::span<const holoflow::core::TDesc> inputs, const nlohmann::json& json,
    const holoflow::core::SyncCreateCtx& context, int mode) {
  const auto settings = json.get<SettingsType>();
  (void)reduction_infer<SettingsType>(inputs, json, mode == 3 ? holoflow::core::DType::U16
                                                               : holoflow::core::DType::F32);
  return std::make_unique<Task>(
      mode, context.stream, make_plan(inputs[0], {settings.axis, settings.keepdims}));
}

} // namespace

void to_json(nlohmann::json& j, const SumSettings& s) {
  serialize_axes(j, {s.axis, s.keepdims});
}
...
holoflow::core::InferResult SumFactory::infer(
    std::span<const holoflow::core::TDesc> inputs, const nlohmann::json& json) const {
  return reduction_infer<SumSettings>(inputs, json, holoflow::core::DType::F32);
}
std::unique_ptr<holoflow::core::ISyncTask> SumFactory::create(
    std::span<const holoflow::core::TDesc> inputs, const nlohmann::json& json,
    const holoflow::core::SyncCreateCtx& context) const {
  return reduction_create<SumSettings>(inputs, json, context, 0);
}
std::unique_ptr<holoflow::core::ISyncTask> SumFactory::update(
    std::unique_ptr<holoflow::core::ISyncTask>, std::span<const holoflow::core::TDesc> inputs,
    const nlohmann::json& json, const holoflow::core::SyncCreateCtx& context) const {
  return reduction_create<SumSettings>(inputs, json, context, 0);
}

holoflow::core::InferResult StdFactory::infer(
    std::span<const holoflow::core::TDesc> inputs, const nlohmann::json& json) const {
  return reduction_infer<StdSettings>(inputs, json, holoflow::core::DType::F32);
}
std::unique_ptr<holoflow::core::ISyncTask> StdFactory::create(
    std::span<const holoflow::core::TDesc> inputs, const nlohmann::json& json,
    const holoflow::core::SyncCreateCtx& context) const {
  return reduction_create<StdSettings>(inputs, json, context, 1);
}
std::unique_ptr<holoflow::core::ISyncTask> StdFactory::update(
    std::unique_ptr<holoflow::core::ISyncTask>, std::span<const holoflow::core::TDesc> inputs,
    const nlohmann::json& json, const holoflow::core::SyncCreateCtx& context) const {
  return reduction_create<StdSettings>(inputs, json, context, 1);
}

holoflow::core::InferResult VarFactory::infer(
    std::span<const holoflow::core::TDesc> inputs, const nlohmann::json& json) const {
  return reduction_infer<VarSettings>(inputs, json, holoflow::core::DType::F32);
}
std::unique_ptr<holoflow::core::ISyncTask> VarFactory::create(
    std::span<const holoflow::core::TDesc> inputs, const nlohmann::json& json,
    const holoflow::core::SyncCreateCtx& context) const {
  return reduction_create<VarSettings>(inputs, json, context, 2);
}
std::unique_ptr<holoflow::core::ISyncTask> VarFactory::update(
    std::unique_ptr<holoflow::core::ISyncTask>, std::span<const holoflow::core::TDesc> inputs,
    const nlohmann::json& json, const holoflow::core::SyncCreateCtx& context) const {
  return reduction_create<VarSettings>(inputs, json, context, 2);
}

holoflow::core::InferResult ArgminFactory::infer(
    std::span<const holoflow::core::TDesc> inputs, const nlohmann::json& json) const {
  return reduction_infer<ArgminSettings>(inputs, json, holoflow::core::DType::U16);
}
std::unique_ptr<holoflow::core::ISyncTask> ArgminFactory::create(
    std::span<const holoflow::core::TDesc> inputs, const nlohmann::json& json,
    const holoflow::core::SyncCreateCtx& context) const {
  return reduction_create<ArgminSettings>(inputs, json, context, 3);
}
std::unique_ptr<holoflow::core::ISyncTask> ArgminFactory::update(
    std::unique_ptr<holoflow::core::ISyncTask>, std::span<const holoflow::core::TDesc> inputs,
    const nlohmann::json& json, const holoflow::core::SyncCreateCtx& context) const {
  return reduction_create<ArgminSettings>(inputs, json, context, 3);
}
