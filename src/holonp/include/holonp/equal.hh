...
void to_json(nlohmann::json &j, const EqualSettings &s);
void from_json(const nlohmann::json &j, EqualSettings &s);
...
class EqualFactory : public holoflow::core::ISyncTaskFactory {
public:
