...
public:
  Argmax(const ArgmaxSettings &settings, cudaStream_t stream, size_t total_out, size_t total_red,
...
class ArgmaxFactory : public holoflow::core::ISyncTaskFactory {
public:
