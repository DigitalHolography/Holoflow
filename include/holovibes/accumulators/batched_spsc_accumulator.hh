...
public:
  ...
  tl::expected<std::optional<TensorView>, Error> write_tensor();

  tl::expected<void, Error> commit_write();

  tl::expected<std::optional<TensorView>, Error> read_tensor();

  tl::expected<void, Error> commit_read();
