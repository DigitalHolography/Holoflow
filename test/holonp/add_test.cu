...
// -------------------------------------------------------------------------------------------------
// AddFactory: execution tests via C++ reference
// -------------------------------------------------------------------------------------------------

class AddReferenceTest : public ::testing::Test {
protected:
  holonp::AddFactory factory;

  // Helper: run factory + reference and compare two same-shape contiguous device tensors.
  template <typename T>
