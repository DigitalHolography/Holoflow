...
| - [padding](#padding ) | No      | object | No         | -          | Optional centered zero-padding resolution. Target dimensions must fit the input and add an even number of pixels on each axis.                        |
